...
class LocalJsonFile_verifyDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank, dataset_name, chat_path):
        ...
        self.raw_datasets = load_dataset('json',
                                        data_files={
                                            ...
                                            chat_path,
                                            "eval":
                                            '/cpfs/user/chennuo/CN/gsm8k-ScRel/data/eval_ins.json'
                                        })
        print('eval dataset is /cpfs/user/chennuo/CN/gsm8k-ScRel/data/eval_ins.json')   
    def get_train_data(self):
        if self.raw_datasets['train'] is not None:
            return self.raw_datasets['train']
        return None
...
## graph_reasoning_dataset

class LocalJsonFile_GraphDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank, dataset_name, chat_path):
        ...
        self.raw_datasets = load_dataset('json',
                                        data_files={
                                            ...
                                            chat_path,
                                            "eval":
                                            '/cpfs/user/chennuo/CN/XMATH-LLM/data/NLGGraph/test_v1.json'
                                        })
