...
class ScriptArguments:
    ...
    # training parameters
    model_name_or_path: Optional[str] = field(default="/hpc2hdd/home/yli258/olddata/yuhanli/LLaMA_v2_ckpts/hf/Llama-2-7b-hf", metadata={"help": "the model name"})
    ...
    max_length: Optional[int] = field(default=4096, metadata={"help": "max length of each sample"})
...
def get_hh(split: str, sanity_check: bool = False, silent: bool = False, cache_dir: str = None) -> Dataset:
    ...
    """
    dataset = load_dataset("/hpc2hdd/home/yli258/jhaidata/trl-main/hh-rlhf", split=split, cache_dir=cache_dir)
    if sanity_check:
